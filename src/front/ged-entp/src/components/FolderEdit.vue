...
export default {
  ...
  mounted() {
    ...
    axios
      .get("http://localhost:30001/document/" + this.$cookies.get("id_doc"))
      .then((response) => {
  ...
  methods: {
    update() {
      ...
      var date = new Date();
        ...
        axios
          .put(
            "http://localhost:30001/documentUpdate/" +
              this.$cookies.get("id_doc"),
            {
